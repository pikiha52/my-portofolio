...
<div class="bg-cyan-500 shadow-md rounded-3xl md:w-full md:h-auto md:px-20 px-5 md:pt-20 pt-5 pb-5 md:pb-20 md:mb-4">
    ...
    <div class="flex justify-center items-center mb-4">
        <p class="font-extrabold font-poppins text-2xl bg-gray-100 rounded-lg text-center uppercase text-cyan-500 px-4 py-4">{{ $portofolio->name }}</p>
    </div>
           ...
           @foreach ($details as $detail)
            <div class="carousel-inner relative w-full overflow-hidden rounded-lg">
              <div class="carousel-item active relative float-left w-full">
                <img
                  src="https://gosystemconsulting.co.id/media/HiRes-17.jpg"
                  class="block w-full"
                  alt="Wild Landscape"
                />
              </div>
