...
<div class="bg-blue-500 dark:bg-gray-900 rounded shadow-lg py-20 px-40">

    <div class="bg-white shadow-lg rounded py-32 px-20">
        
        <div class="grid grid-cols-2 gap-0 w-full">
            <div class="bg-white shadow-lg rounded-xl w-60 h-60">
        ...
        <div class="grid grid-cols-2 gap-10 py-8">
            <div class="bg-white shadow-lg rounded-xl w-full px-8 py-4">
                <p class="font-bold font-poppins text-sm text-blue-500 mb-4">Experince</p>
                <ul class="list-disc">
                    <li>
            ...
            <div class="bg-white shadow-lg rounded-xl w-full px-8 py-4">
                <p class="font-poppins text-sm font-bold text-blue-500 mb-4">Education</p>
                <ul class="list-disc">
                    <li>
                        <p class="text-xs font-normal font-poppins text-gray-600">Universita Bina Sarana Informatika</p>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg px-8 py-4 w-full">
           <div class="flex space-x-4 items-center">
               ...
               <div class="flex space-x-2 text-cyan-500 text-2xl">
