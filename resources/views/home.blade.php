    ...
    <div class="grid grid-cols-2">
        <div class="flex justify-center items-center">
            <div class="grid-rows-none">
                ...
                <p class="text-gray-800 dark:text-white font-poppins text-sm py-10">I'am a Full Stack Developer, i can use Framework Laravel, Codeigniter, Flutter, Tailwindcss. I really like the new thing about programming. </p>
                <div class="grid grid-cols-2">
...
<div class="grid grid-cols-3 gap-4">
        ...
        <div class="relative bg-cyan-500 dark:bg-white shadow-md rounded-md w-full">
            ...
            <div class="absolute w-full h-full rounded-md py-2.5 bottom-0 inset-x-0 hover:bg-gray-300 hover:bg-opacity-50 text-transparent font-extrabold text-2xl hover:text-gray-700 flex justify-center items-center text-center leading-4 uppercase">Mobile Apps Parking</div>
        </div>
